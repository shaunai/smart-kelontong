<x-guest-layout>
    ...
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-md p-8 mx-auto mt-10">
        ...
        @if(request()->query('demo') == 'true')
            <div class="mb-6 rounded-xl bg-[#ebf7f4] p-4 border border-[#bce4d8] shadow-sm">
                <div class="flex items-start">
                    <div class="flex-shrink-0">
                        <svg class="h-5 w-5 text-[#0f6b5c] mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd" />
                        </svg>
                    </div>
                    <div class="ml-3 w-full">
                        <h3 class="text-sm font-bold text-[#0a4d42]">Mode Demo Aktif</h3>
                        <div class="mt-2 text-sm text-[#0f6b5c]">
                            <p class="mb-2">Silakan gunakan salah satu kredensial berikut untuk menguji perbedaan hak akses:</p>
                            
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-2">
                                <div class="bg-white/80 p-3 rounded-lg border border-[#bce4d8]">
                                    <p class="font-bold text-[11px] uppercase tracking-wider text-[#0f6b5c] mb-1.5 flex items-center gap-1">
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
                                        Akses Pemilik
                                    </p>
                                    <ul class="font-mono text-xs space-y-1 text-gray-700">
                                        <li><strong>User:</strong> owner123</li>
                                ...
                                <div class="bg-white/80 p-3 rounded-lg border border-[#bce4d8]">
                                    ...
                                    <ul class="font-mono text-xs space-y-1 text-gray-700">
                                        <li><strong>User:</strong> kasir123</li>
                                        <li><strong>Pass:</strong> password123</li>
                                    </ul>
                                </div>
                            </div>
