        ...
        <div>
            ...
            <nav class="p-4 space-y-2">
                <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-3 {{ request()->routeIs('dashboard') ? 'bg-[#1a7175] text-white' : 'text-gray-500 hover:bg-gray-50' }} rounded-lg transition-colors">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v２a２ ２ ０ ０１－２ ２H６a２ ２ ０ ０１－２－２v－２z"></path></svg>
    ...
    <div class="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header class="h-20 bg-white flex items-center justify-between px-8 shadow-sm z-0">
            <div class="relative w-96">
                ...
                <input type="text" class="block w-full pl-10 pr-3 py-2 border-transparent focus:border-transparent focus:ring-0 text-sm placeholder-gray-400 bg-transparent" placeholder="Cari data.............">
            </div>
